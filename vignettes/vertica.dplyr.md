...
The following have been tested and QA-verified:
...
Please look at the [dplyr docs][1] for how these work. Many others should also be functional, but they have not been extensively QA'ed.

## Auxiliary functions
The following are a list of functions that are used to implement many of the functions listed above in dplyr, and are thus exported as part of the package for dispatch in certain generic functions. They may be used, but are however not meant to be directly invoked by the user, and are thus not documented for their behavior:
